...
function MandatoryPhotoSlot({ label, desc, icon, val, set }: {
  label: string; desc: string; icon: string;
  val: string | null; set: (v: string | null) => void;
}) {
      ...
      {activeTab === 6 && (
        <>
          ...
          <SectionBlock title="Required Documents">
            <div style={grid2}>
              <MandatoryPhotoSlot label="Driver's Licence" desc="Front of the customer's licence" icon="🪪" val={licencePhoto} set={setLicencePhoto} />
              <MandatoryPhotoSlot label="Vehicle Registration Papers" desc="Current registration certificate" icon="📄" val={regoPhoto} set={setRegoPhoto} />
            </div>
          </SectionBlock>
